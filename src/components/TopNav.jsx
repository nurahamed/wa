...
import { MemoryRouter, Link, matchPath, useLocation, Form } from 'react-router-dom';
    ...
    return(
       <Box sx={{display:{sm: 'none'}}}>
            <AppBar component='nav'>
                <Toolbar>
                    <IconButton color='inherit' aria-label='open drower'
                    edge="start"
                    ...
                    <Typography varient ='h6' component="div" sx={{flexGrow:1, display: {sx: 'none', sm: 'block'}}}>
                     Weather App
                    </Typography>
                </Toolbar>
